...
function xmldb_block_panopto_upgrade($oldversion = 0) {
    ...
    if ($oldversion < 2014121502) {
        ...
        $table = new xmldb_table('block_panopto_foldermap');
        $field = new xmldb_field('publisher_mapping', XMLDB_TYPE_CHAR, '20', null, XMLDB_NOTNULL, null, '1', 'panopto_app_key');
        ...
        $table = new xmldb_table('block_panopto_foldermap');
        $field = new xmldb_field('creator_mapping', XMLDB_TYPE_CHAR, '20', null, XMLDB_NOTNULL, null, '3,4', 'publisher_mapping');
