 ...
 */
 /**
 * File for class UserManagementStructSetGroupIsPublic
 ...
 */
/**
 * This class stands for UserManagementStructSetGroupIsPublic originally named SetGroupIsPublic
 ...
 * @date 2017-01-19
 */
class UserManagementStructSetGroupIsPublic extends UserManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $isPublic;
    /**
     * Constructor method for SetGroupIsPublic
     * @see parent::__construct()
     * @param UserManagementStructAuthenticationInfo $_auth
     * @param string $_groupId
     * @param boolean $_isPublic
     * @return UserManagementStructSetGroupIsPublic
     */
    public function __construct($_auth = NULL,$_groupId = NULL,$_isPublic = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'groupId'=>$_groupId,'isPublic'=>$_isPublic),false);
    }
    /**
     * Get auth value
