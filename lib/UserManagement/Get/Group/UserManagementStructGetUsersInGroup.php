 ...
 */
 /**
 * File for class UserManagementStructGetUsersInGroup
 ...
 */
/**
 * This class stands for UserManagementStructGetUsersInGroup originally named GetUsersInGroup
 ...
 * @date 2017-01-19
 */
class UserManagementStructGetUsersInGroup extends UserManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $groupId;
    /**
     * Constructor method for GetUsersInGroup
     * @see parent::__construct()
     * @param UserManagementStructAuthenticationInfo $_auth
     * @param string $_groupId
     * @return UserManagementStructGetUsersInGroup
     */
