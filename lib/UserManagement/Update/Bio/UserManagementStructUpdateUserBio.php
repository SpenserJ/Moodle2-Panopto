 ...
 */
 /**
 * File for class UserManagementStructUpdateUserBio
 ...
 */
/**
 * This class stands for UserManagementStructUpdateUserBio originally named UpdateUserBio
 ...
 * @date 2017-01-19
 */
class UserManagementStructUpdateUserBio extends UserManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $bio;
    /**
     * Constructor method for UpdateUserBio
     * @see parent::__construct()
     * @param UserManagementStructAuthenticationInfo $_auth
     * @param string $_userId
     * @param string $_bio
     * @return UserManagementStructUpdateUserBio
     */
    public function __construct($_auth = NULL,$_userId = NULL,$_bio = NULL)
    {
        parent::__construct(array('auth'=>$_auth,'userId'=>$_userId,'bio'=>$_bio),false);
    }
    /**
     * Get auth value
    ...
    /**
     * Set bio value
     * @param string $_bio the bio
     * @return string
     */
    public function setBio($_bio)
    {
        return ($this->bio = $_bio);
    }
    /**
