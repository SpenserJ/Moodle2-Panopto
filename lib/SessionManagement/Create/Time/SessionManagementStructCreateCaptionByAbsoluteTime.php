 ...
 */
 /**
 * File for class SessionManagementStructCreateCaptionByAbsoluteTime
 ...
 */
/**
 * This class stands for SessionManagementStructCreateCaptionByAbsoluteTime originally named CreateCaptionByAbsoluteTime
 ...
 * @date 2017-01-19
 */
class SessionManagementStructCreateCaptionByAbsoluteTime extends SessionManagementWsdlClass
{
    /**
     * The auth
     * Meta informations extracted from the WSDL
    ...
    public $timestamp;
    /**
     * Constructor method for CreateCaptionByAbsoluteTime
     * @see parent::__construct()
     * @param SessionManagementStructAuthenticationInfo $_auth
     * @param string $_sessionId
     * @param string $_text
     * @param dateTime $_timestamp
     * @return SessionManagementStructCreateCaptionByAbsoluteTime
     */
