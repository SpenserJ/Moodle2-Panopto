...
class AuthManagementWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    ...
    /**
     * Constructor
     * @uses AuthManagementWsdlClass::setLastError()
     * @uses AuthManagementWsdlClass::initSoapClient()
     * @uses AuthManagementWsdlClass::initInternArrayToIterate()
     * @uses AuthManagementWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'AuthManagementWsdlClass'))
            {
     ...
     * @uses AuthManagementClassMap::classMap()
     * @uses AuthManagementWsdlClass::getDefaultWsdlOptions()
     * @uses AuthManagementWsdlClass::getSoapClientClassName()
     * @uses AuthManagementWsdlClass::setSoapClient()
     ...
     * If a class is named as {AuthManagement}SoapClient, then this is the class that will be used.
     ...
     * @uses AuthManagementWsdlClass::WSDL_CACHE_WSDL
     * @uses AuthManagementWsdlClass::WSDL_COMPRESSION
     * @uses AuthManagementWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses AuthManagementWsdlClass::WSDL_ENCODING
     * @uses AuthManagementWsdlClass::WSDL_EXCEPTIONS
     * @uses AuthManagementWsdlClass::WSDL_FEATURES
     * @uses AuthManagementWsdlClass::WSDL_LOGIN
     * @uses AuthManagementWsdlClass::WSDL_PASSWORD
     * @uses AuthManagementWsdlClass::WSDL_SOAP_VERSION
     * @uses AuthManagementWsdlClass::WSDL_STREAM_CONTEXT
     * @uses AuthManagementWsdlClass::WSDL_TRACE
     * @uses AuthManagementWsdlClass::WSDL_TYPEMAP
     * @uses AuthManagementWsdlClass::WSDL_URL
     * @uses AuthManagementWsdlClass::VALUE_WSDL_URL
     * @uses AuthManagementWsdlClass::WSDL_USER_AGENT
     * @uses AuthManagementWsdlClass::WSDL_PROXY_HOST
     * @uses AuthManagementWsdlClass::WSDL_PROXY_PORT
     * @uses AuthManagementWsdlClass::WSDL_PROXY_LOGIN
     * @uses AuthManagementWsdlClass::WSDL_PROXY_PASSWORD
     * @uses AuthManagementWsdlClass::WSDL_LOCAL_CERT
     * @uses AuthManagementWsdlClass::WSDL_PASSPHRASE
     * @uses AuthManagementWsdlClass::WSDL_AUTHENTICATION
     * @uses AuthManagementWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses AuthManagementWsdlClass::getSoapClient()
     * @uses AuthManagementWsdlClass::getFormatedXml()
     ...
     * @uses AuthManagementWsdlClass::getSoapClient()
     * @uses AuthManagementWsdlClass::convertStringHeadersToArray()
     ...
     * @uses AuthManagementWsdlClass::getInternArrayToIterate()
     ...
     * @see AuthManagementWsdlClass::offsetGet()
     * @uses AuthManagementWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses AuthManagementWsdlClass::getAttributeName()
     * @uses AuthManagementWsdlClass::__toString()
     * @uses AuthManagementWsdlClass::_set()
     * @uses AuthManagementWsdlClass::_get()
     * @uses AuthManagementWsdlClass::setInternArrayToIterate()
     * @uses AuthManagementWsdlClass::setInternArrayToIterateIsArray()
     * @uses AuthManagementWsdlClass::setInternArrayToIterateOffset()
